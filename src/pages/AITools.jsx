          ...
          <div className="flex gap-8">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2 bg-gray-950 rounded-xl p-1">
                  <button
              ...
              {filteredTools.length === 0 ? (
                ...
                <div className={`tools-grid ${
                  ...
                  {filteredTools.map((tool) => (
                    ...
                    >
                      <div className="bg-gray-950 rounded-xl p-6 transition-colors duration-300 h-full">
                        <div className="flex items-start gap-4 mb-3">
                          ...
                          {tool.logo ? (
                            <div className="flex-shrink-0">
                              ...
                              />
                              <div className="w-12 h-12 rounded-lg bg-gray-900 hidden items-center justify-center">
                            ...
                            <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-gray-900 flex items-center justify-center">
                              <svg className="w-6 h-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                              </svg>
                            </div>
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          <span className={`px-3 py-1 rounded-lg text-xs font-medium ${
                            tool.pricing === 'freemium' ? 'bg-green-500/10 text-green-400' :
                          ...
                          {tool.isNew && (
                            <span className="px-3 py-1 rounded-lg text-xs font-medium bg-yellow-500/10 text-yellow-400 flex items-center gap-1">
